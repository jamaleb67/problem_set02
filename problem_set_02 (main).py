...
for i in great_wall_list:
     great_wall_item_length.append(len(i))
...
great_wall_string = (great_wall[6:20] + "is in" + great_wall[0:5])
...
unesco_sites = []
for i in china_unesco_sites:
    sites = i.split(",")
    if sites[2] == "Cultural":
        site_info = [sites[0], sites[1], sites[3]]
    unesco_sites.append(' - '.join(site_info))
print(unesco_sites)
